...
<body>
    ...
    <header id="header" class="fixed-top">
        ...
        <a class="navbar-brand mr-auto" href="#">
            <img src="{{ asset('logo_madrasah/PN UJUNG.png') }}" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
            Madrasah PNUP - Admin
        </a>
    ...
    <footer id="footer">
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                Madrasah PNUP | <strong><span>2020</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
