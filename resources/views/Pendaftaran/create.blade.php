...
<body>
    ...
    <section class="breadcrumbs">
        ...
        <section id="contact" class="contact pt-3 pb-3">
            <form action="{{ route('pendaftaran.store') }}" method="post" role="form" class="php-form bg-white" enctype="multipart/form-data">
            {{csrf_field()}}
            @method('post')
            <div class="form-row">
            ...
            <div class="form-group">
                ...
                <div style="position:relative;">
                    <a class='btn btn-primary' href='javascript:;'>
                        Pilih Formulir
                        <input required id="formulir" name="formulir" type="file" style='position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";opacity:0;background-color:transparent;color:transparent;' size="40" onchange='$("#upload-formulir-info").html($(this).val());'>
                    </a>
                    &nbsp;
                    <span class='label label-info' id="upload-formulir-info">{{ old('formulir') }}</span>
                </div>
            </div>
            <div class="form-group">
