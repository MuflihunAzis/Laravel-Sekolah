...
<body>
    ...
    <header id="header" class="fixed-top">
        ...
        <nav class="nav-menu d-none d-lg-block">
            ...
            <li class="active"><a href="{{ route('berita.index') }}">Berita</a></li>
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="post-author">
                    ...
                    <a href="{{ route('berita.delete', $data_berita->id) }}" class="btn btn-danger btn-sm my-1 mr-sm-1" onclick="return confirm('Hapus Data ?')"><i class="nav-icon fas fa-trash"></i>
                    Hapus Data</a>
                </div>
                </div>
