...
<body>
    ...
    <header id="header" class="fixed-top">
        ...
        <a class="navbar-brand mr-auto" href="#">
            <img src="{{ asset('logo_madrasah/'.$profile_madrasah2->logo.'') }}" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
            {{$profile_madrasah2->nama}} - Admin
        </a>
    ...
    <section class="breadcrumbs">
        ...
        <section id="contact" class="contact pt-3 pb-3">
            <form action="{{ route('update-profile-madrasah', $profile_madrasah2->id) }}" method="post" role="form" class="php-form bg-white" enctype="multipart/form-data">
            {{csrf_field()}}
            @method('put')
            <div class="form-group">
                <label for="nama">Nama Sekolah</label>
                <input type="text" class="form-control" name="nama" id="nama" value="{{$profile_madrasah2->nama}}" required>
                <div class="validate"></div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                <label for="jumlah_rombel">Jumlah Rombongan Belajar</label>
                <input type="number" class="form-control" name="jumlah_rombel" id="jumlah_rombel" value="{{$profile_madrasah2->jumlah_rombel}}" required />
                <div class="validate"></div>
                </div>
                <div class="form-group col-md-6">
                <label for="jumlah_siswa">Jumlah Siswa</label>
                <input type="number" name="jumlah_siswa" class="form-control" id="jumlah_siswa" value="{{$profile_madrasah2->jumlah_siswa}}" required />
                <div class="validate"></div>
                </div>
            </div>
            <div class="form-row">
                ...
                <input type="number" class="form-control" name="jumlah_guru" id="jumlah_guru" value="{{$profile_madrasah2->jumlah_guru}}" required />
                <div class="validate"></div>
                </div>
                <div class="form-group col-md-6">
                <label for="jumlah_tendik">Jumlah Tenaga Kependidikan</label>
                <input type="number" name="jumlah_tendik" class="form-control" id="validationTooltip05" value="{{$profile_madrasah2->jumlah_tendik}}" required />
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="10" data-rule="minlen:20" data-msg="Deskripsi minimal 20 karakter" required>{{$profile_madrasah2->deskripsi}}</textarea>
                <div class="validate"></div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                ...
                <div style="position:relative;">
                    ...
                    &nbsp;
                    <span class='label label-info' id="upload-gambar-info">{{$profile_madrasah2->gambar}}</span>
                </div>
                </div>
                <div class="form-group col-md-6">
                ...
                <div style="position:relative;">
                    ...
                    &nbsp;
                    <span class='label label-info' id="upload-logo-info">{{$profile_madrasah2->logo}}</span>
                </div>
                </div>
            </div>
    ...
    <footer id="footer">
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                {{$profile_madrasah2->nama}} | <strong><span>2024</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
