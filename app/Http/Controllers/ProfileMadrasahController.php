...
class ProfileMadrasahController extends Controller
{
    public function index(){
        ...
        $profile_madrasah2 = ProfileMadrasah::orderByRaw('created_at DESC')->paginate(1);
        return view('profilemadrasah.index', compact('profile_madrasah', 'profile_madrasah2'));
    }
    ...
    {
        $profile_madrasah2 = ProfileMadrasah::find($id);
        $madrasah = ProfileMadrasah::first();
        return view('profilemadrasah.edit', compact('profile_madrasah2', 'madrasah'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('profile-madrasah')->with('success', 'Edit data sukses');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('profile-madrasah')->with("success", "Data berhasil disimpan");
    }
}
